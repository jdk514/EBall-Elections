...
/*	$sql = "CREATE DATABASE IF NOT EXISTS {$database}";
	...
	$sql = "CREATE TABLE IF NOT EXISTS Students (gwid VARCHAR(9) PRIMARY KEY, firstname VARCHAR(50),
			...
			senior_vote BOOLEAN NOT NULL default 0, fun_vote BOOLEAN NOT NULL default 0); CREATE TABLE IF NOT EXISTS Faculty (id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
